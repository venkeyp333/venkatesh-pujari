...
import LamborghiniModel from '../../assets/3dModels/CarModels/lamborghini_sian_fkp_37_custom.glb'; // Correct import for the GLB model
...
// Lamborghini Car Component
const Lamborghini = () => {
  const { scene } = useGLTF(LamborghiniModel); // Load the GLTF model using the correct path
