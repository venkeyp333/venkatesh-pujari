...
import RaiderModel from '../../assets/3dModels/CarModels/race_car_driver.glb'; // Correct import for the GLB model
...
// Raider Car Component
const Raider = () => {
  const { scene } = useGLTF(RaiderModel); // Load the GLTF model using the correct path
